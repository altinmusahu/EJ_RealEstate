...
const SearchInOffers = () => {
  ...
  const filteredOffers = properties
  .filter((property) => selectedLocation === "" || property.City === selectedLocation)
  .filter((property) => (minPrice === "" || Number(property.Price) >= Number(minPrice)))
  .filter((property) => (maxPrice === "" || Number(property.Price) <= Number(maxPrice)));
  ...
  return (
    <div className="w-full h-full">
      <div className="w-full h-16 text-center text-slate-900 text-5xl font-bold font-['Merriweather'] leading-10 mx-auto mt-16">
        Search for an offer
      </div>
      <div className="w-full h-11 text-center text-slate-900 text-xl font-normal font-['Open Sans'] leading-9">
      ...
      <div className="w-96 h-14 relative mx-auto mt-8">
        ...
        <div className="flex justify-between mt-8">
          <div className="w-28 relative bg-white border-2 border-slate-900 rounded-md">
            <input
              type="number"
              placeholder="Min Price"
              className="w-full h-full p-2 text-slate-900 text-base font-normal font-['Open Sans'] leading-relaxed"
              value={minPrice}
      ...
      <div className="flex flex-wrap justify-center items-center md:flex-row gap-6 lg:mt-20 mt-12 mb-8">
