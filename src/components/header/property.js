...
import { fetchPropertyByID } from "../../store/propertyID-slice";
...
const Details = () => {
    ...
    const property = useSelector((state) => state.propertyID.property);
  ...
  return (
    <div>
        <div className="h-32 text-slate-900 text-5xl font-bold font-['Merriweather'] leading-10 ml-28"> {property.PropertyName} </div>
        <div className="flex flex-cols-2">
            ...
            <div className="w-[70%] mt-8 ml-28 relative">
                ...
                <div className="lg:flex items-center justify-start flex-row ml-40 mt-10 w-full h-full">
                    ...
                    <div className="text-slate-900 text-xl font-bold font-['Merriweather'] leading-7 px-12">Apartaments</div>
                    ...
                    <div className="text-slate-900 text-xl font-bold font-['Merriweather'] leading-7 px-12"> {property.SquareFeet}m<span className="text-slate-900 text-sm font-bold font-['Merriweather'] leading-7">
                    ...
                    <div className="text-slate-900 text-xl font-bold font-['Merriweather'] leading-7 px-10">{property.City}</div>
                ...
                <div className="w-[70%] h-24 bg-slate-100 rounded ml-28 mt-10 p-3">
                    ...
                    <div className="text-slate-900 text-xl font-bold font-['Merriweather'] leading-7">{property.Price}</div>
                </div>
                ...
                <div className="w-[70%] ml-28">
                    ...
                    <p className="text-slate-900 text-base font-normal font-['Open Sans'] leading-relaxed">
                        * number of rooms: {property.Bedrooms}<br/>
                        * number of bathrooms: {property.Bathrooms}<br/>

                        * apartment area: {property.SquareFeet} m2<br/>
                        * address: {property.Address}<br/>
                 
                    </p>
                    <p className="text-slate-900 text-xl font-bold font-['Merriweather'] leading-7">Layout solution:<br/></p>
                    <p className="text-slate-900 text-base font-normal font-['Open Sans'] leading-relaxed">
                        Kitchen, living room, study, {property.Bedrooms} bedrooms, {property.Bathrooms} bathrooms, wardrobe, fireplace. Two garage parking spaces in the underground garage.<br/>
