...
const Home = () => {
  ...
  return (
    <div className="flex items-start mt-5">
      <div className="flex flex-col items-start justify-start p-10 pl-40">
        <div className="text-start w-4/5 mt-12">
          ...
          <div className="w-full h-24 bg-slate-100 rounded border-b-2 mt-12 relative flex gap-4">
...
<div className="w-72 h-36 relative">
  ...
  <div className="w-2 h-2 left-[81px] top-[144px] absolute bg-slate-100 rounded-full" />
            ...
            <div className="absolute flex justify-end items-end right-0 mr-44 mt-8">
