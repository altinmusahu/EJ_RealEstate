...
const Details2 = () => {
  const imageUrls = [
    'https://www.decorilla.com/online-decorating/wp-content/uploads/2022/11/Luxury-interior-design-home-designing.jpeg',
    'https://www.decorilla.com/online-decorating/wp-content/uploads/2021/07/luxury-home-interior-design-Kitchen.jpg',
    'https://artfasad.com/wp-content/uploads/2023/08/bedroom-luxury-house-interior-5.jpg',
    'https://www.thepinnaclelist.com/wp-content/uploads/2019/12/002-Feature-Floor-Tiles-Luxury-Home-Design-4-High-End-Bathroom-Installation-Ideas.jpg'
  ];
  ...
  const descriptions = [
    ...
    "A kitchen that blends style and functionality seamlessly.",
    "Cozy bedroom with stylish decor.",
    "Modern, chic bathroom with sleek fixtures and stylish design."
  ];
  ...
  return (
    <div>
        <div className="h-32 text-slate-900 text-5xl font-bold font-['Merriweather'] leading-10 ml-28">3-Bedroom Gem Featuring Stylish Design and Comfortable Living Spaces.</div>
        <div className="flex flex-cols-2">
            ...
            <div className="w-[70%] mt-8 ml-28 relative">
                ...
                <div className="lg:flex items-center justify-start flex-row ml-40 mt-10 w-full h-full">
                    ...
                    <div className="text-slate-900 text-xl font-bold font-['Merriweather'] leading-7 px-12">House</div>
                    ...
                    <div className="text-slate-900 text-xl font-bold font-['Merriweather'] leading-7 px-12"> 200m<span className="text-slate-900 text-sm font-bold font-['Merriweather'] leading-7">
                    ...
                    <div className="text-slate-900 text-xl font-bold font-['Merriweather'] leading-7 px-10">Madrid</div>
                ...
                <div className="w-[70%] h-24 bg-slate-100 rounded ml-28 mt-10 p-3">
                    ...
                    <div className="text-slate-900 text-xl font-bold font-['Merriweather'] leading-7">1700.00 €/ month</div>
                </div>
