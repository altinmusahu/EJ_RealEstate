...
const Details3 = () => {
  const imageUrls = [
    ...
    'https://static.vecteezy.com/system/resources/previews/026/586/130/large_2x/modern-kitchen-interior-design-in-apartment-or-house-with-furniture-luxury-kitchen-home-scandinavian-concept-by-ai-generated-free-photo.jpg',
  ...
  const descriptions = [
    "Unwind in a living space adorned with breathtaking vistas.",
  ...
  return (
    <div>
        <div className="h-32 text-slate-900 text-5xl font-bold font-['Merriweather'] leading-10 ml-28"> Luxury living, featuring cutting-edge amenities and a <br></br> stylish design</div>
        <div className="flex flex-cols-2">
            ...
            {/* <div className="flex space-x-4 mt-28 flex-col">
                ...
                <div className="lg:flex items-center justify-start flex-row ml-40 mt-10 w-full h-full">
                    ...
                    <div className="text-slate-900 text-xl font-bold font-['Merriweather'] leading-7 px-12"> 182m<span className="text-slate-900 text-sm font-bold font-['Merriweather'] leading-7">
                    ...
                    <div className="text-slate-900 text-xl font-bold font-['Merriweather'] leading-7 px-10">Valencia</div>
                ...
                <div className="w-[70%] h-24 bg-slate-100 rounded ml-28 mt-10 p-3">
                    ...
                    <div className="text-slate-900 text-xl font-bold font-['Merriweather'] leading-7">999.57 €/ month</div>
                </div>
